package com.toucan.light.toucanlightapplication.firebase;
...
import static com.toucan.light.toucanlightapplication.firebase.DocumentSnapshotMapper.DOCUMENT_EXISTENCE_PREDICATE;
import static com.toucan.light.toucanlightapplication.firebase.DocumentSnapshotMapper.QUERY_EXISTENCE_PREDICATE;
...
public class RxFirestore {
     ...
     */
    @NonNull
    public static Single<DocumentSnapshot> getDocument(@NonNull final DocumentReference ref) {
        return Single.create(new SingleOnSubscribe<DocumentSnapshot>() {
            @Override
            public void subscribe(final SingleEmitter<DocumentSnapshot> emitter) throws Exception {
     ...
     */
    @NonNull
    public static Single<QuerySnapshot> getCollection(@NonNull final CollectionReference ref) {
        return Single.create(new SingleOnSubscribe<QuerySnapshot>() {
            @Override
     ...
     */
    @NonNull
    public static Single<QuerySnapshot> getCollection(@NonNull final Query query) {
        return Single.create(new SingleOnSubscribe<QuerySnapshot>() {
            @Override
            public void subscribe(final SingleEmitter<QuerySnapshot> emitter) throws Exception {
     ...
     */
    @NonNull
    private static <T> Maybe<List<T>> getCollection(
     ...
     */
    @NonNull
    public static <T> Single<T> getDocument(@NonNull final DocumentReference ref,
                                            @NonNull final Class<T> clazz) {
